...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css =
      ...
      ".tu_heatL1{background:color-mix(in srgb,#3b82f6 26%,var(--dsw-alias-bg-layer-1))}" +
      ".tu_heatL2{background:color-mix(in srgb,#3b82f6 46%,var(--dsw-alias-bg-layer-1))}" +
      ".tu_heatL3{background:color-mix(in srgb,#3b82f6 70%,var(--dsw-alias-bg-layer-1))}" +
      ...
      ".tu_yearLabel{min-width:46px;text-align:center;color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-mono);font-size:12px;font-variant-numeric:tabular-nums}" +
