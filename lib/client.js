...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css =
      ...
      ".tu_colDay{flex:2.2;min-width:0;color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code,ui-monospace,SFMono-Regular,Menlo,monospace);font-size:11px;white-space:nowrap;text-overflow:ellipsis;overflow:hidden}" +
