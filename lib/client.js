...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css =
      ...
      ".tu_segValue{color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code,ui-monospace,SFMono-Regular,Menlo,monospace);font-size:12px;font-variant-numeric:tabular-nums}" +
      ...
      "width:min(340px,calc(100vw - 32px));background:var(--dsw-alias-bg-layer-2);" +
      "border:1px solid var(--dsw-alias-border-l2);border-radius:12px;box-shadow:var(--dsw-elevation-panel,var(--dsw-shadow-lv3));" +
      ...
      ".tu_rowValue{color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code,ui-monospace,SFMono-Regular,Menlo,monospace);font-variant-numeric:tabular-nums}" +
      ".tu_meter{height:4px;border-radius:999px;background:var(--dsw-alias-bg-skeleton);overflow:hidden}" +
      ...
      ".tu_overlay{position:fixed;inset:0;z-index:300;display:flex;align-items:center;justify-content:center;padding:24px;background:var(--dsw-alias-bg-mask-3,rgba(0,0,0,.45))}" +
      ".tu_card{box-sizing:border-box;width:min(1040px,100%);max-height:min(86vh,760px);overflow:auto;display:flex;" +
      "flex-direction:column;gap:16px;background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);" +
      "border-radius:16px;box-shadow:var(--dsw-elevation-panel,var(--dsw-shadow-lv3));padding:20px 24px}" +
      ...
      ".tu_cardStat{flex:1;min-width:110px;display:flex;flex-direction:column;gap:2px;background:var(--dsw-alias-bg-skeleton);border-radius:10px;padding:10px 12px}" +
      ".tu_cardStatLabel{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}" +
      ".tu_cardStatValue{color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code,ui-monospace,SFMono-Regular,Menlo,monospace);font-size:17px;line-height:24px;font-variant-numeric:tabular-nums}" +
      ...
      ".tu_heat{display:flex;gap:3px;align-items:flex-start;overflow-x:auto;padding:2px 0}" +
      ".tu_heatCol{display:flex;flex-direction:column;gap:3px;flex:1 1 0;min-width:9px}" +
      ".tu_heatCell{width:100%;height:auto;aspect-ratio:1/1;border-radius:2.5px;flex:none;box-sizing:border-box}" +
      ".tu_heatCell[role=button]{cursor:pointer}" +
      ".tu_heatPad{background:transparent}" +
      ".tu_heatL0{background:color-mix(in srgb,var(--dsw-alias-label-tertiary) 18%,transparent);" +
      "box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--dsw-alias-label-tertiary) 16%,transparent)}" +
      ".tu_heatFuture{background:transparent;opacity:.4;" +
      "box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--dsw-alias-label-tertiary) 30%,transparent)}" +
      ".tu_heatL1{background:color-mix(in srgb,#3b82f6 26%,var(--dsw-alias-bg-layer-2))}" +
      ".tu_heatL2{background:color-mix(in srgb,#3b82f6 46%,var(--dsw-alias-bg-layer-2))}" +
      ".tu_heatL3{background:color-mix(in srgb,#3b82f6 70%,var(--dsw-alias-bg-layer-2))}" +
      ".tu_heatL4{background:#2563eb}" +
      ".tu_heatToday{box-shadow:inset 0 0 0 1.5px var(--dsw-alias-label-primary)}" +
      ".tu_heatSel{box-shadow:0 0 0 2px color-mix(in srgb,var(--dsw-alias-label-secondary) 55%,transparent)}" +
      ".tu_heatMonths{display:flex;gap:3px;font-size:10px;color:var(--dsw-alias-label-tertiary);line-height:14px;padding-top:2px}" +
      ".tu_heatMonths span{flex:1 1 0;min-width:9px;white-space:nowrap;overflow:visible}" +
      ".tu_heatLegend{display:flex;align-items:center;justify-content:flex-end;gap:4px;font-size:11px;color:var(--dsw-alias-label-tertiary)}" +
      ".tu_heatLegend .tu_heatCell{width:13px;height:13px;aspect-ratio:auto}" +
      ".tu_barToday{background:var(--dsw-alias-label-secondary)}" +
      ".tu_barEmpty{background:var(--dsw-alias-bg-skeleton);cursor:default}" +
      ...
      ".tu_yearNav{display:flex;align-items:center;gap:2px}" +
      ".tu_yearBtn{display:inline-flex;align-items:center;justify-content:center;width:26px;height:26px;border:1px solid var(--dsw-alias-border-l2);" +
      "border-radius:8px;background:transparent;color:var(--dsw-alias-label-secondary);font-size:14px;line-height:1;cursor:pointer}" +
      ".tu_yearBtn:hover:not(:disabled),.tu_yearBtn:focus-visible:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}" +
      ".tu_yearBtn:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}" +
      ".tu_yearLabel{min-width:46px;text-align:center;color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code,ui-monospace,SFMono-Regular,Menlo,monospace);font-size:12px;font-variant-numeric:tabular-nums}" +
      ...
      ".tu_tableRow:hover{background:var(--dsw-alias-interactive-bg-hover)}" +
      ".tu_colModel{flex:2.2;min-width:0;color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code,ui-monospace,SFMono-Regular,Menlo,monospace);font-size:11px;white-space:nowrap;text-overflow:ellipsis;overflow:hidden}" +
      ".tu_colNum{flex:1;min-width:96px;text-align:right;color:var(--dsw-alias-label-secondary);font-family:var(--ds-font-family-code,ui-monospace,SFMono-Regular,Menlo,monospace);font-variant-numeric:tabular-nums;white-space:nowrap}" +
      ".tu_colNumWide{flex:1.35}" +
      ".tu_colShare{flex:1.2;min-width:80px;display:flex;align-items:center;gap:6px}" +
      ".tu_colShareBar{flex:1;height:4px;border-radius:999px;background:var(--dsw-alias-bg-skeleton);overflow:hidden}" +
      ...
      ".tu_colModels{flex:1.1;min-width:0;text-align:center;color:var(--dsw-alias-label-secondary);font-size:11px;white-space:nowrap;text-overflow:ellipsis;overflow:hidden}" +
      ".tu_tableHead .tu_colNum,.tu_tableHead .tu_colNumWide,.tu_tableHead .tu_colDay,.tu_tableHead .tu_colModel,.tu_tableHead .tu_colModels,.tu_tableHead .tu_colShare{text-align:center}" +
      ...
      ".tu_dayRowBtn{display:flex;align-items:center;gap:10px;width:100%;box-sizing:border-box;font-family:inherit;font-size:12px;line-height:22px;color:inherit;text-align:left;background:transparent;border:0;border-radius:8px;padding:2px 8px;cursor:pointer}" +
      ".tu_dayRowBtn:hover{background:var(--dsw-alias-interactive-bg-hover)}" +
      ".tu_colDay{flex:2;min-width:0;color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code,ui-monospace,SFMono-Regular,Menlo,monospace);font-size:11px;white-space:nowrap;text-overflow:ellipsis;overflow:hidden}" +
    ...
    var styles = {
      ...
      heat: "tu_heat",
      heatCol: "tu_heatCol",
      heatCell: "tu_heatCell",
      heatPad: "tu_heatPad",
      heatFuture: "tu_heatFuture",
      heatL0: "tu_heatL0",
      heatL1: "tu_heatL1",
      heatL2: "tu_heatL2",
      heatL3: "tu_heatL3",
      heatL4: "tu_heatL4",
      heatToday: "tu_heatToday",
      heatSel: "tu_heatSel",
      heatMonths: "tu_heatMonths",
      heatLegend: "tu_heatLegend",
      barToday: "tu_barToday",
      barEmpty: "tu_barEmpty",
      chartX: "tu_chartX",
      sectionTitleRow: "tu_sectionTitleRow",
      colNumWide: "tu_colNumWide",
      yearNav: "tu_yearNav",
      yearBtn: "tu_yearBtn",
      yearLabel: "tu_yearLabel",
      table: "tu_table",
    ...
    /** Weekday index with Monday = 0 (heatmap rows). */
    function weekdayMonday(date) {
      return (date.getDay() + 6) % 7;
    }
    /**
     * GitHub-style calendar grid over the inclusive [start, end] range: one
     * column per week, seven rows per weekday (Monday first). Padding cells
     * fall outside the range and render as blanks, so the grid stays aligned
     * however many days accumulate.
     */
    function buildHeatmap(index, start, end) {
      var padStart = weekdayMonday(new Date(start + "T00:00:00"));
      var padEnd = 6 - weekdayMonday(new Date(end + "T00:00:00"));
      var gridStart = addDays(start, -padStart);
      var cellCount = diffDays(gridStart, end) + padEnd + 1;
      var todayKey = dayKeyOf(0);
      var weeks = [];
      for (var i = 0; i < cellCount; i++) {
        var day = addDays(gridStart, i);
        var inRange = day >= start && day <= end;
        var entry = inRange ? index[day] : void 0;
        if (i % 7 === 0) weeks.push([]);
        weeks[weeks.length - 1].push({
          day: day,
          inRange: inRange,
          total: entry === void 0 ? 0 : entry.total,
          searches: entry === void 0 ? 0 : entry.searchCalls || 0,
    ...
    /** Intensity bucket 0-4 for a day total relative to the range maximum. */
    ...
    /** Per-week month label (only where the month changes), browser-localized. */
    function monthLabels(weeks) {
      var labels = [];
      var lastMonth = "";
      for (var i = 0; i < weeks.length; i++) {
        var first = weeks[i][0];
        var month = first.day.slice(0, 7);
        if (first.inRange && month !== lastMonth) {
          labels.push(new Date(first.day + "T00:00:00").toLocaleDateString(void 0, { month: "short" }));
          lastMonth = month;
        } else {
          labels.push("");
        }
    ...
    /**
     * Global token-consumption panel: a GitHub-style yearly activity heatmap
     * (grey = no usage, blue ramp = usage, ghosted = future days), per-model
     * breakdown with share bars, and a per-day drilldown table. Data comes from
     * GET /api/token-stats (the host half scans the session logs). It fetches
     * once when opened; the header button re-reads on demand.
     */
    function GlobalStatsPanel({ onClose, t }) {
      ...
      var yearPair = React.useState(function () { return new Date().getFullYear(); });
      var year = yearPair[0];
      var setYear = yearPair[1];
      ...
      if (Array.isArray(byDay) && byDay.length > 0) {
        var firstYear = Number(String(byDay[0].day).slice(0, 4));
        if (Number.isFinite(firstYear)) earliestYear = Math.min(firstYear, currentYear);
      }
      var heatWeeks = byDayIndex === null ? [] : buildHeatmap(byDayIndex, year + "-01-01", year + "-12-31");
      var maxDay = 1;
      var hasRangeData = false;
      for (var wi = 0; wi < heatWeeks.length; wi++) {
        for (var ci = 0; ci < heatWeeks[wi].length; ci++) {
          var heatCell = heatWeeks[wi][ci];
          if (!heatCell.inRange) continue;
          if (heatCell.total > maxDay) maxDay = heatCell.total;
          if (!heatCell.isEmpty) hasRangeData = true;
        }
      }
      var canPrevYear = year > earliestYear;
      var canNextYear = year < currentYear;
      var shiftYear = function (delta) {
        setYear(function (prev) {
          var next = prev + delta;
          if (next < earliestYear || next > currentYear) return prev;
          return next;
        });
      };
          ...
          children: [
            jsxs("div", {
              ...
              children: [
                ...
                jsx("div", { className: styles.cardStat, title: t("global.card.searchesHint"), children: [jsx("div", { className: styles.cardStatLabel, children: t("global.card.searches") }), jsx("div", { className: styles.cardStatValue, children: formatNumber(data.searchCalls) })] }),
            ...
            jsxs("div", {
              ...
              children: [
                    ...
                    jsxs("div", {
                      ...
                      children: [
                        jsx("button", {
                          ...
                          title: t("global.year.prev"),
                          "aria-label": t("global.year.prev"),
                          disabled: !canPrevYear,
                          onClick: function () { shiftYear(-1); },
                          children: "‹"
                        }),
                        jsx("span", { className: styles.yearLabel, children: year }),
                        jsx("button", {
                          type: "button",
                          className: styles.yearBtn,
                          title: t("global.year.next"),
                          "aria-label": t("global.year.next"),
                ...
                jsx("div", {
                  ...
                  children: heatWeeks.map(function (week, weekIndex) {
                    return jsx("div", {
                      className: styles.heatCol,
                      children: week.map(function (cell) {
                        var selected = hourDay === cell.day;
                        // Three states: untouched padding, ghosted future days,
                        // then "no usage" grey or one of four blue levels.
                        var tone = !cell.inRange
                          ? styles.heatPad
                          : cell.isFuture
                            ? styles.heatFuture
                            : cell.total > 0
                              ? styles["heatL" + heatLevel(cell.total, maxDay)]
                              : styles.heatL0;
                        return jsx("div", {
                          className: styles.heatCell + " " + tone +
                            (cell.isToday ? " " + styles.heatToday : "") +
                            (selected ? " " + styles.heatSel : ""),
                          role: cell.inRange ? "button" : void 0,
                          tabIndex: cell.inRange ? 0 : void 0,
                          "aria-expanded": cell.inRange ? selected : void 0,
                          "aria-label": cell.inRange ? t("global.hoursAria", { day: cell.day, total: formatNumber(cell.total) }) : void 0,
                          title: !cell.inRange
                            ? void 0
                            : cell.isFuture
                              ? cell.day + " · " + t("global.heat.future")
                              : cell.day + " · " + formatNumber(cell.total) + " tokens · " + t("global.col.searches") + " " + formatNumber(cell.searches),
                          onClick: cell.inRange ? function () {
                            setHourDay(function (current) { return current === cell.day ? null : cell.day; });
                          } : void 0,
                          onKeyDown: cell.inRange ? function (event) {
                ...
                jsx("div", {
                  className: styles.heatMonths,
                  children: monthLabels(heatWeeks).map(function (label, labelIndex) {
                    return jsx("span", { children: label }, String(labelIndex));
                  })
                }),
                jsxs("div", {
                  className: styles.heatLegend,
                  children: [
                    jsx("span", { className: styles.heatCell + " " + styles.heatL0 }),
                    jsx("span", { children: t("global.heat.none") }),
                    jsx("span", { className: styles.sep, children: "·" }),
                    jsx("span", { children: t("global.heat.less") }),
                    jsx("span", { className: styles.heatCell + " " + styles.heatL1 }),
                    jsx("span", { className: styles.heatCell + " " + styles.heatL2 }),
                    jsx("span", { className: styles.heatCell + " " + styles.heatL3 }),
                    jsx("span", { className: styles.heatCell + " " + styles.heatL4 }),
                    jsx("span", { children: t("global.heat.more") })
                  ]
                }),
                !hasRangeData ? jsx("div", { className: styles.hintMeta, children: t("global.year.empty") }) : null,
                ...
                jsx("div", {
                  ...
                  children: [
                    jsx("div", { className: styles.tableHead, children: [
                      ...
                      jsx("span", { className: styles.colNum + " " + styles.colNumWide, children: t("global.col.total") }),
                      jsx("span", { className: styles.colNum + " " + styles.colNumWide, children: t("global.col.input") }),
                      jsx("span", { className: styles.colNum + " " + styles.colNumWide, children: t("global.col.output") }),
                      jsx("span", { className: styles.colNum, children: t("global.col.searches") }),
                        ...
                        children: [
                          jsxs("button", {
                            ...
                            children: [
                              ...
                              jsx("span", { className: styles.colNum + " " + styles.colNumWide, children: formatNumber(entry.total) }),
                              jsx("span", { className: styles.colNum + " " + styles.colNumWide, children: formatNumber(entry.input) }),
                              jsx("span", { className: styles.colNum + " " + styles.colNumWide, children: formatNumber(entry.output) }),
                              jsx("span", {
                                className: styles.colNum,
                                title: t("global.card.searchesHint"),
                                children: formatNumber(entry.searchCalls)
                              }),
                          ...
                          open ? jsxs("div", {
                            ...
                            children: [
                              jsx("div", { className: styles.hintMeta, children: t("global.daySearches", { count: formatNumber(entry.searchCalls || 0) }) }),
                              jsx("div", { className: styles.tableHead, children: [
                                jsx("span", { className: styles.colModel, children: t("global.col.model") }),
    ...
    var zh = {
      ...
      "global.card.searches": "搜索",
      "global.card.searchesHint": "网页搜索旁路调用次数（单独计费，不计入 Token 合计）",
      "global.card.requests": "请求数",
      "global.card.sessions": "会话数",
      "global.section.chart": "每日消耗趋势",
      "global.year.prev": "上一年",
      "global.year.next": "下一年",
      "global.year.empty": "该年暂无数据",
      "global.heat.less": "少",
      "global.heat.more": "多",
      "global.heat.none": "无消耗",
      "global.heat.future": "尚未到来",
      "global.section.models": "按模型汇总",
      "global.section.days": "按日明细",
      "global.daysHint": "点击日期（或柱状图）展开该日各模型明细",
      "global.daySearches": "该日网页搜索：{count} 次",
    ...
    var en = {
      ...
      "global.card.searches": "Searches",
      "global.card.searchesHint": "Web-search sidecar calls (billed separately; not included in token totals)",
      "global.card.requests": "Requests",
      "global.card.sessions": "Sessions",
      "global.section.chart": "Daily usage trend",
      "global.year.prev": "Previous year",
      "global.year.next": "Next year",
      "global.year.empty": "No data in this year",
      "global.heat.less": "Less",
      "global.heat.more": "More",
      "global.heat.none": "No usage",
      "global.heat.future": "Not yet",
      ...
      "global.daySearches": "Web searches this day: {count}",
