...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css =
      ...
      ".tu_card{box-sizing:border-box;width:min(860px,100%);max-height:min(86vh,760px);overflow:auto;display:flex;" +
    ...
    /** Index the byDay array by day key. */
    ...
    /** Last CHART_DAYS days as chart cells (missing days render empty bars). */
    function buildChartDays(index) {
      var cells = [];
        ...
        statusNode = jsxs(React.Fragment, {
          children: [
              ...
              children: [
                ...
                jsx("div", {
                  ...
                  children: chartDays.map(function (cell) {
                    return jsx("div", {
                      className: styles.bar + (cell.isToday ? " " + styles.barToday : "") + (cell.isEmpty ? " " + styles.barEmpty : ""),
                ...
                jsx("div", {
                  ...
                  children: chartDays.map(function (cell, index) {
                    return jsx("span", { children: index % 5 === 0 ? cell.day.slice(5) : "" }, cell.day);
                  })
                })
              ]
            }),
            jsxs("div", {
              className: styles.section,
              children: [
                jsx("div", { className: styles.sectionTitle, children: t("global.section.models") }),
                jsx("div", {
            ...
            jsxs("div", {
              ...
              children: [
                ...
                jsx("div", {
                  ...
                  children: [
                    jsx("div", { className: styles.tableHead, children: [
                      jsx("span", { className: styles.colModel, children: t("global.col.day") }),
                      jsx("span", { className: styles.colNum, children: t("global.col.total") }),
                      jsx("span", { className: styles.colNum, children: t("global.col.input") }),
                      jsx("span", { className: styles.colNum, children: t("global.col.output") }),
                      jsx("span", { className: styles.colNum, children: t("global.col.requests") }),
                      jsx("span", { className: styles.colModels, children: t("global.col.models") })
                    ] }),
                    byDay.slice().reverse().map(function (entry) {
                      var models = (entry.models || []).slice(0, 2).map(function (m) {
                        return m.model + " " + formatCompact(m.total);
                      }).join(" · ");
                      return jsx("div", {
                        className: styles.tableRow,
                        key: entry.day,
                        children: [
                          jsx("span", { className: styles.colModel, children: entry.day }),
                          jsx("span", { className: styles.colNum, children: formatNumber(entry.total) }),
                          jsx("span", { className: styles.colNum, children: formatNumber(entry.input) }),
                          jsx("span", { className: styles.colNum, children: formatNumber(entry.output) }),
                          jsx("span", { className: styles.colNum, children: formatNumber(entry.requests) }),
                          jsx("span", { className: styles.colModels, title: models, children: models === "" ? "—" : models })
                        ]
                      });
                    })
                  ]
    ...
    var zh = {
      ...
      "global.section.chart": "近 30 天每日消耗",
      "global.section.models": "按模型",
    ...
    var en = {
      ...
      "global.section.chart": "Daily usage · last 30 days",
      "global.section.models": "By model",
