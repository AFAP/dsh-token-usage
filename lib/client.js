              ...
              children: [
                ...
                jsx("div", {
                  ...
                  children: chartDays.map(function (cell) {
                    var barOpen = expandedDay === cell.day;
                    return jsx("div", {
                      className: styles.bar + (cell.isToday ? " " + styles.barToday : "") + (cell.isEmpty ? " " + styles.barEmpty : "") + (barOpen ? " " + styles.barOpen : ""),
                      role: "button",
                      tabIndex: 0,
                      "aria-expanded": barOpen,
                      "aria-label": t("global.expandDayAria", { day: cell.day, total: formatNumber(cell.total) }),
                      title: cell.day + " · " + formatNumber(cell.total) + " tokens",
                      onClick: function () {
                        setExpandedDay(function (current) { return current === cell.day ? null : cell.day; });
                      },
